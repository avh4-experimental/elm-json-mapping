module JsonMappingSpec exposing (all)

import Expect
import Json.Decode
import JsonMapping exposing (ObjectMapping, bool, customType, int, list, maybe, object, static, string, variant0, variant1, variant2, with)
